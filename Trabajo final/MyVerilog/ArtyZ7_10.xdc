...
## Switches
set_property -dict { PACKAGE_PIN M20 IOSTANDARD LVCMOS33 } [get_ports { Xin }]; #IO_L7N_T1_AD2N_35 Sch=SW0
set_property -dict { PACKAGE_PIN M19 IOSTANDARD LVCMOS33 } [get_ports { Yin }]; #IO_L7P_T1_AD2P_35 Sch=SW1
set_property -dict { PACKAGE_PIN L15 IOSTANDARD LVCMOS33 } [get_ports { angle }]; #IO_L22N_T3_AD7P_35 Sch=LED4_B
...
## Pmod Header JA
set_property -dict { PACKAGE_PIN Y18 IOSTANDARD LVCMOS33 } [get_ports { Xout }]; #IO_L17P_T2_34 Sch=JA1_P (Pin 1)
set_property -dict { PACKAGE_PIN Y19 IOSTANDARD LVCMOS33 } [get_ports { Yout }]; #IO_L17N_T2_34 Sch=JA1_N (Pin 2)
